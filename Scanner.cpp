...
static const flex_int16_t yy_nxt[25] =
    {   0,
        4,    5,    6,    7,    8,    9,    4,   13,   14,   13,
       12,   10,   12,   11,   10,   15,    3,   15,   15,   15,
       15,   15,   15,   15
    } ;
...
YY_RULE_SETUP
#line 32 "Scanner.l"
{ yylval->sval = new std::string(yytext); return token::VARIABLE_NAME; }
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 33 "Scanner.l"
